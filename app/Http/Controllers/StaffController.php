...
class StaffController extends Controller
{
    ...
    */
    ...
    public function sendConfirmationEmail($userInfo)
    {
        ...
        $messageBody1 = "Welcome to Imperia!".PHP_EOL."Your email: ". $userInfo->email." has been registered into our platform!".PHP_EOL."Please click on the link below to set your password.";

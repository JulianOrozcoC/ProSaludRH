                ...
                @if(count($organizations) > 0)
                    ...
                    <ul class="collapsible popout" data-collapsible="accordion">
                        ...
                        @foreach($organizations as $organization)
                            <li>
                                <div class="collapsible-header primary-color-text">{{$organization->name}} <a href="#delete-organization-modal" class="right modal-trigger delete-organization tooltipped" data-tooltip="Delete organization" data-organization-id="{{$organization->id}}"><i class="material-icons red-text">delete</i></a></div>
                                    ...
                                    <ul class="collection">
                                        @foreach($organization->users as $user)
                                            <li class="collection-item">
                                                ...
                                                <div class="">
                                                    <span class="primary-color-text">&#x2609;</span><b> {{$user->username}}</b> ({{$user->email}}) 
                                                </div>
                                            </li>
                                        @endforeach
                                    </ul>
